...
Make sure your script is executable and that all required permissions are correctly set. Remember to modify the `$BASE_PATH` variable in the `src/run_scraper.sh` script to the appropriate local path.
