...
def load_headers_from_file():
    ...
    """
    print("📂 STEP 1: Loading headers from './base_headers.py'...")
    try:
        ...
        if "datadome" not in BASE_HEADERS.get("cookie", ""):
            print("⚠️ WARNING: 'datadome' cookie not found in the loaded headers.")
            print(
        ...
        print("❌ ERROR: 'base_headers.py' not found.")
...
def get_sample_headers():
    ...
    """
    print("⚙️  STEP 1: Loading sample headers for the test...")
